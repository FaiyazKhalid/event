...
module.exports = function (app, io) {
    ...
    app.post('/callback', function (req, res) {
        ...
        request.get({ url: "https://api.instagram.com/v1/tags/" + req.body[0]["object_id"] + "/media/recent?client_id=73cec7670f2e427a9de45a33ef5c01bf", form: data }, function (err, response, body) {
    ...
    module.requestToInstagram = function () {
        request.post({ url: "https://api.instagram.com/v1/subscriptions", form: data }, function (err, response, body) {
            if (err) {
